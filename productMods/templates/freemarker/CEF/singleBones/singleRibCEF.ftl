...
${scripts.add(
	...
	'<script type="text/javascript" src="${urls.base}/js/UIModules/coherentBoneEntryForm/RibController.js"></script>',
...
${scripts.add(
    '<script type="text/javascript" src="${urls.base}/js/customConfigData/CEF/symmetricSkeletalDivision/singleRibConfig.js"></script>')}
