...
${scripts.add(
	...
	'<script type="text/javascript" src="${urls.base}/js/UIModules/coherentBoneEntryForm/CoherentSkeletalSubdivision.js"></script>',
	'<script type="text/javascript" src="${urls.base}/js/UIModules/coherentBoneEntryForm/CoherentSkeletalDivision.js"></script>',
...
${scripts.add(
    '<script type="text/javascript" src="${urls.base}/js/customConfigData/profilePage/coherentSkeletalDivision/query.js"></script>',
    '<script type="text/javascript" src="${urls.base}/js/customConfigData/profilePage/coherentSkeletalDivision/pageConfig.js"></script>')}
