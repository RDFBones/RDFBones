...
public class TripleLib {
  ...
  public static List<Triple> schemeTriplesTypes(){
    ...
    triple.add(new ExistingRestrictionTriple(new InputNode("boneOrgan"), "rdf:type", "boneOrganType"));
    triple.add(new ExistingRestrictionTriple(new InputNode("categoricalLabel"), "rdf:type", "categoricalLabelType"));
    return triple;
  }
  ...
  public static Form sdeForm() {
    ...
    SubformAdder measurementDatum = new SubformAdder("measurementDatum", "Measurement Type", "measurementDatumType");
  ...
  public static Form csrForm(){
    ...
    SubformAdder measurementFormElement = new SubformAdder("measurementDatumType", "Bone Segment");
    Form measurementForm = new Form("");
    measurementForm.formElements.add(measurementFormElement);
    
    SubformAdder boneSegmentFormElement = new SubformAdder("bonyPartSegmentType", "Bone Segment");
    ...
    SubformAdder skeletalRegion = new SubformAdder("skeletalRegionType", "Skeletal Regions");
  ...
  public static List<Triple> csrSchemeTriples(){
    ...
    triples.add(new RestrictionTriple(new FormInputNode("bonyPartType"), "obo-fma:constitutional_part_of",
        new FormInputNode("boneOrganType"), "owl:someValuesFrom"));
    triples.add(new RestrictionTriple(new FormInputNode("boneOrganType"), "obo-fma:systemic_part_of",
        new FormInputNode("skeletalRegionType"), "owl:someValuesFrom"));
    triples.add(new RestrictionTriple(new FormInputNode("skeletalRegionType"), "obo-fma:systemic_part_of",
  ...
  public static List<Triple> csrTypeTriples(){
    ...
    List<Triple> triples = new ArrayList<Triple>();
    triples.add(new Triple("object", "rdf:type",
        new MainInputNode("rangeUri")));
    triples.add(new MultiTriple("skeletalRegion", "rdf:type",
        new FormInputNode("skeletalRegionType")));
    triples.add(new MultiTriple("boneOrgan", "rdf:type",
        new FormInputNode("boneOrganType")));
    triples.add(new Triple("bonyPart", "rdf:type",
          "bonyPartType"));
    triples.add(new Triple("bonyPartSegment", "rdf:type",
          "bonyPartSegmentType"));
    triples.add(new Triple("measurementDatum", "rdf:type",
          "measurementDatumType"));
    triples.add(new Triple(new MainInputNode("subject"), 
        "rdf:type", "skeletalInventoryType"));
    return triples;
  }
  ...
  public static List<Triple> csrDataTriples(){
    ...
    List<Triple> triples = new ArrayList<Triple>();
    triples.add(new Triple("subject", "obo:BFO_0000051",
        "measurementDatum"));
  ...
  public static List<Triple> srDataTriples(){
    ...
    List<Triple> triples = new ArrayList<Triple>();
    triples.add(new MultiTriple("object", "rdf:type",
        new FormInputNode("skeletalRegionType")));
    triples.add(new MultiTriple("boneOrgan", "rdf:type",
        new FormInputNode("boneOrganType")));
    triples.add(new Triple("bonyPart", "rdf:type",
  ...
  public static List<Triple> sbSchemeTriples(){
    ...
    triples.add(new RestrictionTriple("skeletalInventoryType", "obo:BFO_0000051",
        new FormInputNode("measurementDatumType"), "owl:someValuesFrom"));
    triples.add(new RestrictionTriple(new FormInputNode("measurementDatumType"), "obo:IAO_0000136",
    ...
    triples.add(new RestrictionTriple("bonyPartType", "obo-fma:constitutional_part_of",
        new FormInputNode("boneOrganType"), "owl:someValuesFrom"));
    triples.add(new RestrictionTriple(new FormInputNode("boneOrganType"), "obo-fma:systemic_part_of",
        "skeletalRegionType", "owl:someValuesFrom"));
