...
public class AddSingleBone {
  ...
  public static List<Triple> getTriples() {
    ...
    triples.add(new ConstantNewInstance("completeness",
        ...
        "http://w3id.org/rdfbones/core#Completeness2State", true));
    triples.add(new Triple("completeness",
        "http://purl.obolibrary.org/obo/OBI_0000999", "comp2State"));
    triples.add(new Triple("individual",
        "http://purl.obolibrary.org/obo/BFO_0000051", "completeness", true));
    return triples;
  }
